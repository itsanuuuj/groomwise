...
public static class AppointmentFilters
{
    ...
    public static readonly Expression<Func<Appointment, bool>> IsThisMonth = appointment =>
       appointment.Date >= new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1) &&
       appointment.Date < new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1).AddMonths(3);
